// lib/types.ts — TypeScript DTOs that mirror the backend's response shapes.
// These must stay in sync with main.py's Pydantic response models.
// Do NOT add frontend-only fields here — keep this a pure API contract layer.
...
export interface UserModel {
  /** Opaque base64-encoded model id — use as-is for PUT/DELETE requests. */
  id: string;
  model_entry: string;
  provider: string;
  tier: Tier;
